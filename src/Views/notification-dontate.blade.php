<!-- notification-dontate.blade.php -->
<div id="notif29" class="notifBox">
    <div class="notifX"><a href="/map?notif=29&notifOnly=1" target="hidFrame" onClick="return hideNotif(29);"
        ><img src="/images/spacer.gif" border=1 height=15 width=15 ></a></div> 
    <div class="notifDesc condensed"><table border=0 cellpadding=0 cellspacing=0 ><tr>
        <td rowspan=2 ><img src="/images/notif-heart.jpg" border=0 ></td>
        <td class="notifNote" rowspan=2 style="padding-right: 30px;">
        ...
        <td style="margin: 0px; text-align: left; position: relative;">
            <div class="absDiv" style="top: -4px; left: -4px;">
                <a href="https://www.patreon.com/morganlesko" target="_blank" 
                    ...
                    padding: 0px;"><img src="/images/patreon_navigation_logo_mini_orange.png" border=0 height=36 
                        style="margin: 4px 5px -2px 7px;"></div></a>
            </div>
            <div class="absDiv" style="top: -4px; left: 62px;">
            ...
            <div class="absDiv" style="top: -2px; left: 177px;">
                <a href="/images/qr-code.jpg" rel="shadowbox"><nobr><img src="/images/bitcoin.png" height=30 border=0 >
                    <img src="/images/qr-code.jpg" height=30 border=0 ></nobr></a></td>
            </div>
            <div class="absDiv" style="top: 38px; left: 502px; font-size: 8pt;">1BLcNNL4bv8fQ8d4XN9KXt7T2LU2pjLMN5</div>
        </td></tr>
    </table></div>
</div>